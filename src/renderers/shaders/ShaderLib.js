...
THREE.ShaderLib = {
	...
	'lambert': {
		...
		fragmentShader: [
			...
			"const vec3 pointlight12color = vec3(0.9, 0.3, 0.3);",
			"const vec3 pointlight34color = vec3(0.5, 0.5, 0.8);",
			...
			"float diffuse1 = max(0.0, dot(Neye, L1) * intensity1 * (cos(time * 3.0 + 3.14159) * 0.4 + 0.6));",
			"float diffuse2 = max(0.0, dot(Neye, L2) * intensity2 * (cos(time * 3.0 + 3.14159) * 0.4 + 0.6));",
			"float diffuse3 = max(0.0, dot(Neye, L3) * intensity3 * (cos(time * 3.0) * 0.4 + 0.6));",
			"float diffuse4 = max(0.0, dot(Neye, L4) * intensity4 * (cos(time * 3.0) * 0.4 + 0.6));",
